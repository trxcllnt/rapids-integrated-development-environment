...
RUN export DEBIAN_FRONTEND=noninteractive \
 ...
 && apt install --no-install-recommends -y \
    gpg wget libssl-dev ca-certificates software-properties-common \
...
#           -D BUILD_CUML_PRIMS_BENCH=$BUILD_BENCH \
...
#           -D SINGLEGPU=ON \
#           -D RAFT_USE_FAISS_STATIC=OFF \
#           -D CUML_USE_FAISS_STATIC=OFF \
#           -D CUML_USE_TREELITE_STATIC=OFF \
